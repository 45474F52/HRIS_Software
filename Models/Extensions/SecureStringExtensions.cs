...
namespace HRIS_Software.Models.Extensions
{
    /// <summary>
    /// Содержит методы-расширения для класса <see cref="SecureString"/>
    /// </summary>
    internal static class SecureStringExtensions
    {
        ...
        /// </summary>
        /// <returns>Возвращает расшифрованный текст или <see cref="string.Empty"/>,
        /// если зашифрованная строка была пустой или равной <see langword="null"/></returns>
        ...
        /// <remarks>
        /// Метод создаёт новый экзепляр класса <see cref="SecureString"/>,
        /// даже при передаче пустого значения <paramref name="password"/>
        /// </remarks>
